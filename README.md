...
This repository should not be used for anything other than hosting the MTA-STS policy. Changes to the policy file may affect email delivery for `mgrealestate.eu`.
